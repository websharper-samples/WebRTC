...
declare module Site {
    ...
    module MinMaxTimeDomain {
        ...
        var Analyser : {
            (stream: __ABBREV.__JavaScript.MediaStream): void;
        };
        var LoadSound : {
            (onNotSupported: {
                (x: __ABBREV.__JavaScript.MediaStreamError): void;
            }): void;
        };
        var Main : {
        ...
        var javascriptNode : {
            (): __ABBREV.__JavaScript.ScriptProcessorNode;
        };
        var CanvasEl : {
            (): __ABBREV.__Client.Element;
        };
        ...
        var um : {
            (): __ABBREV.__JavaScript.UserMedia;
        };
        var Sample : {
    ...
    module ASCIICamera {
        ...
        module Camera {
            ...
            var InitVideoStream : {
                (video: __ABBREV.__JavaScript.HTMLVideoElement, onNotSupprted: {
                    (x: __ABBREV.__JavaScript.MediaStreamError): void;
                }): any;
            };
            var Start : {
        ...
        module Ascii {
            ...
            var GetColorAtOffset : {
                (data: number[], offset: number): any;
            };
            var Bound : {
                <_M1>(value: _M1, minn: _M1, maxx: _M1): _M1;
            };
            var AsciiFromCanvas : {
                (canvas: __ABBREV.__JavaScript.CanvasElement): string;
            };
            var characters : {
                (): string;
            };
        ...
        interface Video {
            Video: __ABBREV.__JavaScript.HTMLVideoElement;
            Handle: __ABBREV.__WebSharper.OptionProxy<any>;
            Playing: boolean;
        }
        var UserMedia : {
            (): __ABBREV.__JavaScript.UserMedia;
    ...
    module AudioHolder {
        ...
        var SetCurrent : {
            (src: any, jsnode: __ABBREV.__JavaScript.ScriptProcessorNode): void;
        };
        var currentPlaying : {
            (): __ABBREV.__WebSharper.OptionProxy<any>;
        };
        var jsNode : {
            (): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__JavaScript.ScriptProcessorNode>;
        };
    }
}
declare module __ABBREV {
