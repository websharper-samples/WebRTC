...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Site,ASCIICamera,Application,Number,Ascii,AudioHolder,jQuery,navigator,Camera,Samples,List,Html,Client,Attr,Tags,T,Math,String,Operators,Arrays,window,Option,Set,MinMaxTimeDomain,Client1,Uint8Array,Seq,Builder,Sample,document,Operators1,Unchecked,EventsPervasives;
 Runtime.Define(Global,{
  Site:{
   ASCIICamera:{
    Application:{
     ...
     Main:function(elem)
     {
      ...
      if(!function(tupledArg)
      {
      ...
      })
       {
        ...
        _this["HtmlProvider@33"].SetCss(_this.get_Body(),"display","none");
      ...
      else
       {
        onNotSupprted=function()
        {
         ...
         _this1["HtmlProvider@33"].SetCss(_this1.get_Body(),"display","none");
     ...
     {
      var arg10;
      arg10=List.ofArray([Attr.Attr().NewAttr("style",Application.style())]);
      return Tags.Tags().NewTag("pre",arg10);
     }),
     canvas:Runtime.Field(function()
     {
      var arg10,arg101,arg102;
      arg101=Global.String(ASCIICamera.width());
      arg102=Global.String(ASCIICamera.height());
      arg10=List.ofArray([Attr.Attr().NewAttr("width",arg101),Attr.Attr().NewAttr("height",arg102)]);
     ...
     video:Runtime.Field(function()
     {
      ...
      arg102=Global.String(ASCIICamera.height());
      arg10=List.ofArray([Attr.Attr().NewAttr("width",arg101),Attr.Attr().NewAttr("height",arg102)]);
      return Tags.Tags().NewTag("video",arg10);
     })
    },
    Ascii:{
     ...
     {
      return{
       Red:Arrays.get(data,offset),
       Green:Arrays.get(data,offset+1),
       Blue:Arrays.get(data,offset+2),
       Alpha:Arrays.get(data,offset+3)
      };
     },
   ...
   MinMaxTimeDomain:{
    ...
    {
     var arg10;
     arg10=List.ofArray([Attr.Attr().NewAttr("width","800"),Attr.Attr().NewAttr("height","256"),Attr.Attr().NewAttr("style","background-color: black;")]);
     return Tags.Tags().NewTag("canvas",arg10);
    }),
    DrawTimeDomain:function(ctx,array)
    {
     var c,value,width,value1,height,minValue,maxValue,max,min,_;
     ...
     Seq.iteri(function()
     {
      return function(a)
      {
       var value2;
       value2=Number(a)/256;
       if(value2>maxValue[0])
        {
         maxValue[0]=value2;
        }
       return value2<minValue[0]?void(minValue[0]=value2):null;
      };
